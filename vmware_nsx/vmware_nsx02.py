...
"""Alta3 Research | RZFeeser@alta3.com
   NSX - Demos how to make a basic REST API calls to an NSX Manager Server.  It shows how to use basic authorization, and how to get data back as XML for JSON.

   Adapted from:
   https://developer.vmware.com/samples/1988/python-code-to-use-the-nsx-manager-rest-api-interface"""
