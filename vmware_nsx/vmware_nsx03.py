...
"""Alta3 Research | RZFeeser@alta3.com
   Create Transport Zone in NSX-T -
   This script will perform the following actions,
   - Register vCenter server to NSX-T
   - Create Transport Zone in the NSX-T

   Adapted from:
   https://developer.vmware.com/samples/7643/create-transport-zone-in-nsx-t"""
