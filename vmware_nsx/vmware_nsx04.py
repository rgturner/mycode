...
"""Alta3 Research | RZFeeser@alta3.com
   NSXV Host Preparation
   This script will get the cluster MOID and perform the install NSXV agents on the same cluster

   Adapted from:
   https://developer.vmware.com/samples/7648/nsxv-host-preparation"""
